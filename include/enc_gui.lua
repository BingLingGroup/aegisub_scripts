...
{	
	...
	{x=1,y=0,width=5,class="edit",name="vid",value=vfull},
	{x=6,y=0,class="label",label="Source audio:"},
	{x=7,y=0,width=3,class="edit",name="aid",value=afull},
	...
	{x=0,y=2,class="label",label="Encoder to use:"},
	...
	{x=0,y=7,class="label",label="Target name:"},
